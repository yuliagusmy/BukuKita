...
import { LayoutDashboard, BookOpen, BarChart2, Award, BookPlus, UserCircle } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row">
      ...
      <header className="bg-white shadow-sm py-4 px-4 flex justify-between items-center md:hidden">
        <h1 className="text-xl font-bold text-indigo-700">BookQuest</h1>
      ...
      <aside className="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0">
        <div className="flex flex-col flex-grow bg-white shadow-lg overflow-y-auto">
          <div className="flex items-center justify-center h-16 flex-shrink-0 px-4">
            <h1 className="text-2xl font-bold text-indigo-700">BookQuest</h1>
          </div>
          <div className="px-4 py-4 mb-4">
            <div className="bg-indigo-50 rounded-lg p-4">
              <div className="flex items-center justify-between mb-2">
                <span className="font-medium text-indigo-900">{userStats.title}</span>
