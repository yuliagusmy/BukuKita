...
import { Award, Bookmark, BookOpen, Calendar, CheckSquare, Star } from 'lucide-react';
...
const ProfilePage: React.FC = () => {
  ...
  return (
    <div className="bg-[#E3F0FF] min-h-screen py-8 px-2 md:px-8">
      <h1 className="text-2xl font-bold text-blue-900 mb-8">Your Profile</h1>

      {/* Level Card */}
      <div className="bg-white rounded-3xl shadow-lg overflow-hidden mb-8">
        <div className="bg-gradient-to-r from-blue-500 to-purple-400 px-6 py-8 text-white">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-3xl font-bold mb-1 drop-shadow">{userStats.title}</h2>
              <p className="text-blue-100">Level {userStats.level} Reader</p>
            </div>
          ...
          <div className="mt-6">
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm text-blue-100">XP: {userStats.xp} / {userStats.xpToNextLevel}</span>
              <span className="text-sm text-blue-100">{levelProgress}%</span>
            </div>
